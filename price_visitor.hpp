...
class Price_Visitor : public Visitor {
        ...
        public:
                ...
                virtual void visit_pizza(Pizza* p) {
                        this->crust_c  = p->get_cost();
                        this->cost.push_back(this->crust_c);
                        this->cheese_c = p->get_cost();
                        this->cost.push_back(this->cheese_c);

                        this->sauce_c  = p->get_cost();
                        this->cost.push_back(this->sauce_c);
